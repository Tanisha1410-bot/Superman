...
export { i as formatProviderDisplayName } from './types-FOY4YYJo.js';
import { ag as HubOAuthMode, ah as HubConnectSessionResult, ai as HubPermissionSessionResult, H as HubConfig, aj as HubConfigInput, ak as HubConnectSessionInput, al as HubListProjectConnectionsInput, A as AccountKeyManagerFor, am as HubPermissionSessionInput } from './index-DKIQbeNM.js';
export { an as DEFAULT_HUB_API_URL, ao as HubEnvironmentSlug } from './index-DKIQbeNM.js';
import { g as TunnelType, c as ProcessCorsairRequest, h as WebhookTenantLink } from './index-CXpDAEOf.js';
export { i as BROWSER_DELIVERY_TTL_MS, j as BrowserDeliveryMode, B as BrowserDeliveryPayload, S as SIGNED_TUNNEL_REPLAY_WINDOW_MS, f as TunnelEnvelope } from './index-CXpDAEOf.js';
export { b as buildBrowserDeliveryRedirectUrl, s as signBrowserDeliveryToken, v as verifyBrowserDeliveryToken } from './browser-delivery-DE71IK5C.js';
...
declare function parseConnectSessionResponse(payload: unknown): HubConnectSessionResult;
declare function parseProjectConnectionsResponse(payload: unknown): HubProjectConnection[];
declare function parsePermissionSessionResponse(payload: unknown): HubPermissionSessionResult;
declare function parseOAuthRefreshResponse(payload: unknown): HubOAuthRefreshResponse;
 ...
 */
declare function signDeliveryEnvelope(input: {
    projectId: string;
 ...
 */
declare function verifyDeliveryEnvelope(input: {
    body: string;
 ...
 */
declare function verifySignedTunnelDelivery(input: {
    body: string;
 ...
 */
declare function parseServerDeliveryAckBody(body: string): ServerDeliveryAckBody;
/**
 * Determines whether the app accepted a server delivery based on HTTP status and body.
 */
declare function isServerDeliveryAckSuccessful(input: {
    httpOk: boolean;
    status: number;
 ...
 */
declare function extractSyncFromDeliveryAck(body: ServerDeliveryAckBody): {
    encrypted: string;
} | null;
/**
 * Parses sync payload from a raw delivery HTTP body using the standard ack contract.
 */
declare function parseSyncFromDeliveryBody(body: string): {
    encrypted: string;
} | null;
/**
 * Formats a fetch/network failure into a user-facing delivery reachability error.
 */
declare function describeDeliveryNetworkError(deliveryUrl: string, error: unknown): string;
/**
 ...
 */
declare function formatServerDeliveryError(input: FormatServerDeliveryErrorInput): string;
/**
 ...
 */
declare function deliverSignedEnvelope(input: {
    deliveryUrl: string;
    projectId: string;
    signingSecret: string;
    type: TunnelType;
...
declare function createHubPermissionSession(hub: HubConfig, input: HubPermissionSessionInput): Promise<HubPermissionSessionResult>;
declare function formatHubApprovalMessage(approvalUrl: string): string;
 ...
 */
declare function registerHubWebhookTenantLink(hub: HubConfig, input: {
    plugin: string;
    tenantId: string;
...
declare function createConnectSessionJti(): string;
/** Default TTL for connect session URL tokens (20 minutes). */
declare function getConnectSessionExpiryMs(): number;
/**
 * Signs the token embedded in the connect page URL (`/connect/[token]`).
 */
declare function signConnectSessionToken(payload: Omit<ConnectSessionTokenPayload, 'exp' | 'iat'>, signingSecret: string): string;
/**
 * Verifies a connect session URL token when the connect UI or API loads session state.
 */
declare function verifyConnectSessionToken(token: string, signingSecret: string): ConnectSessionTokenPayload | null;
/** Decodes a connect session token from a URL path segment. */
declare function decodeConnectSessionTokenFromPath(encoded: string): string;
...
declare function createConnectTokenJti(): string;
/** Default TTL for connect OAuth tokens (10 minutes). */
declare function getConnectTokenExpiryMs(): number;
/**
...
declare function encodeConnectTokenForPath(token: string): string;
/** Decodes a connect token from a URL path segment. */
declare function decodeConnectTokenFromPath(encoded: string): string;
...
declare function createPermissionSessionJti(): string;
/**
 ...
 */
declare function signPermissionToken(payload: Omit<PermissionTokenPayload, 'exp' | 'iat'>, signingSecret: string, expiresAt: Date): string;
/**
 * Verifies a permission approval URL token when the approve UI loads session state.
 */
declare function verifyPermissionToken(token: string, signingSecret: string): PermissionTokenPayload | null;
/** Decodes a permission token from a URL path segment. */
declare function decodePermissionTokenFromPath(encoded: string): string;
