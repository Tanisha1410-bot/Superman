...
import { A as AuthTypes, l as AllErrors, M as ManagementOk, T as Tenant, C as CreateTenantInput, P as PluginInfo, a as ConnectionStatus, f as PermissionLookupInput, b as PermissionRecord, d as CreateConnectLinkInput, c as ConnectLink, R as ResolvedConnectLink, e as OAuthCallbackInput, O as OAuthCallbackResult, g as AllProviders } from './types-C24LhkXl.js';
import { C as CorsairPermission } from './index-eydqYIn0.js';
 ...
 */
declare class ReadonlyForbiddenError extends Error {
 ...
 */
declare function runReadonly<T>(fn: () => T): T;
/** Whether the current async context is inside a {@link runReadonly} scope. */
declare function isReadonlyScopeActive(): boolean;
/**
 ...
 */
declare function assertReadonlyAllowed(endpointPath: string, riskLevel: EndpointRiskLevel): void;
/**
 ...
 */
interface CorsairRunsNamespace {
 ...
 */
interface CorsairThreadsNamespace {
 ...
 */
interface CorsairWorkflowsNamespace {
 ...
 */
type CorsairPluginSubscribeResult = {
 ...
 */
type CorsairPluginSubscribe = (ctx: any, input: {
    webhookUrl: string;
 ...
 */
type CorsairPermissionsOptions = {
    /**
 ...
 */
type CorsairDeprecatedApprovalConfig = {
    /**
...
export { type PermissionPolicy as $, type AccountKeyManagerFor as A, type BaseAuthFieldConfig as B, type CorsairPlugin as C, type EnforcePermissionOptions as D, type EndpointPathsOf as E, type EnforcePermissionResult as F, assertReadonlyAllowed as G, type HubConfig as H, type IntegrationKeyManagerFor as I, isReadonlyScopeActive as J, ReadonlyForbiddenError as K, runReadonly as L, type BeforeHookResult as M, type CorsairKeyBuilder as N, type OAuthConfig as O, type PluginAuthConfig as P, type CorsairKeyBuilderBase as Q, type RetryStrategies as R, type CorsairPluginContext as S, type TokenResponse as T, type CorsairPluginSubscribe as U, type EndpointHooks as V, type WebhookTenantMatch as W, type EndpointMetaEntry as X, type EndpointRiskLevel as Y, type KeyBuilderContext as Z, type PermissionMode as _, type CorsairPermissionsOptions as a, type PluginEndpointMeta as a0, type PluginPermissionsConfig as a1, type RequiredPluginEndpointMeta as a2, type RequiredPluginEndpointSchemas as a3, type RequiredPluginWebhookSchemas as a4, type WebhookHooks as a5, type AgentReply as a6, type CorsairThreadsNamespace as a7, type CreateThreadResult as a8, type ThreadHandle as a9, type HubEnvironmentSlug as aA, type ThreadMessage as aa, type ThreadSummary as ab, type Bivariant$2 as ac, type UnionToIntersection$1 as ad, type BindWebhooks as ae, type BoundWebhook as af, type BoundWebhookTree as ag, type CorsairOAuthWebhookTenantLinkResolver as ah, type CorsairWebhook as ai, type CorsairWebhookHandler as aj, type CorsairWebhookMatcher as ak, type CorsairWebhookTenantMatcher as al, type RawWebhookRequest as am, type WebhookPathsOf as an, type WebhookRequest as ao, type WebhookResponse as ap, type WebhookTree as aq, type CorsairManageNamespace as ar, type HubOAuthMode as as, type HubConnectSessionResult as at, type HubPermissionSessionResult as au, type HubConfigInput as av, type HubConnectSessionInput as aw, type HubListProjectConnectionsInput as ax, type HubPermissionSessionInput as ay, DEFAULT_HUB_API_URL as az, type CorsairManualConfig as b, type CorsairIntegration as c, type CorsairTenantWrapper as d, type CorsairSingleTenantClient as e, type CorsairPluginSubscribeResult as f, type AccountFieldNames as g, type BaseKeyManager as h, type IntegrationFieldNames as i, type OAuth2IntegrationCredentials as j, BASE_AUTH_FIELDS as k, exchangeCodeForTokens as l, type CorsairClient as m, type BindEndpoints as n, type BoundEndpointFn as o, type BoundEndpointTree as p, type CorsairContext as q, type CorsairEndpoint as r, type EndpointTree as s, type CorsairErrorHandler as t, type ErrorContext as u, type ErrorHandler as v, type ErrorHandlerAndMatchFunction as w, type ErrorMatcher as x, type RetryStrategy as y, type CorsairPermissionsNamespace as z };
