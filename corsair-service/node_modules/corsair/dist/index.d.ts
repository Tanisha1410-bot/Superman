import { C as CorsairClientOptions, a as CorsairManagementClient } from './types-Dt339hBs.js';
export { b as CorsairClientError } from './types-Dt339hBs.js';
export { c as createCorsair } from './index-B_P6rcu8.js';
import { e as CorsairSingleTenantClient, C as CorsairPlugin, d as CorsairTenantWrapper, m as CorsairClient, z as CorsairPermissionsNamespace, ag as BoundWebhookTree, am as RawWebhookRequest, al as CorsairWebhookTenantMatcher, ap as WebhookResponse } from './index-DcJhvFt7.js';
export { ar as CorsairManageNamespace, b as CorsairManualConfig, a as CorsairPermissionsOptions, K as ReadonlyForbiddenError, L as runReadonly } from './index-DcJhvFt7.js';
import { F as FormFieldSchema, L as ListOperationsOptions } from './tenant-match-utils-Dq3dd_Zs.js';
export { A as AuthMissingError, g as PermissionRequiredError, k as PluginWebhookMatchers, R as ResolveConnectLinkResult, W as WebhookPluginTenantMatch, l as asRecord, h as collectPluginWebhookMatchers, n as decodePubSubData, p as firstString, f as formatDocSchemaShape, q as getHeader, m as matchWebhookPlugin, j as matchWebhookPluginAndTenant, t as readBodyRecord, r as resolveConnectLink, v as toExternalId } from './tenant-match-utils-Dq3dd_Zs.js';
export { SetupCorsairOptions, setupCorsair } from './setup.js';
export { O as OAuthCallbackTunnelPayload, f as ProcessCorsairOptions, g as ProcessCorsairRequest, l as ResolveAccountFromWebhookLinkInput, T as TunnelAck, j as TunnelEnvelope, k as TunnelType, m as WebhookTenantLink, W as WebhookTunnelPayload, p as processCorsair, r as resolveAccountFromWebhookLink, h as resolveTenantFromWebhookLink, i as resolveTenantIdFromWebhookLink, s as setWebhookTenantLink } from './index-CsNw9hYU.js';
import { B as BaseProviders } from './types-C24LhkXl.js';
export { c as ConnectLink, a as ConnectionStatus, d as CreateConnectLinkInput, C as CreateTenantInput, M as ManagementOk, e as OAuthCallbackInput, O as OAuthCallbackResult, f as PermissionLookupInput, b as PermissionRecord, k as PluginConnectionState, P as PluginInfo, R as ResolvedConnectLink, T as Tenant } from './types-C24LhkXl.js';
import './db.js';
import 'kysely';
 ...
 */
type AnyCorsairInstance = CorsairSingleTenantClient<readonly InspectCorsairPlugin[]> | CorsairTenantWrapper<readonly InspectCorsairPlugin[]> | CorsairClient<readonly InspectCorsairPlugin[]>;
/**
 ...
 */
declare function executePermission(corsair: CorsairInstance$1, token: string): Promise<PermissionExecuteResult>;
 ...
 * ```
 */
declare function processWebhook(corsair: CorsairInstance, headers: WebhookHeaders, body: WebhookBody | string, query?: {
    tenantId?: string;
