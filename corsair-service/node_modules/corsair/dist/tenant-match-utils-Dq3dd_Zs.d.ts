import { Y as EndpointRiskLevel, C as CorsairPlugin, ak as CorsairWebhookMatcher, al as CorsairWebhookTenantMatcher, am as RawWebhookRequest, W as WebhookTenantMatch } from './index-DcJhvFt7.js';
import { g as AllProviders } from './types-C24LhkXl.js';
...
export { AuthMissingError as A, type DocSchemaFieldRow as D, type EndpointSchemaResult as E, type FormFieldSchema as F, type IntrospectPluginForDocsResult as I, type ListOperationsOptions as L, type PluginDocsIntrospection as P, type ResolveConnectLinkResult as R, type WebhookPluginTenantMatch as W, type DocSchemaShape as a, type DocsApiEndpoint as b, type DocsDbEntity as c, type DocsDbFilterField as d, type DocsWebhook as e, formatDocSchemaShape as f, PermissionRequiredError as g, collectPluginWebhookMatchers as h, introspectPluginForDocs as i, matchWebhookPluginAndTenant as j, type PluginWebhookMatchers as k, asRecord as l, matchWebhookPlugin as m, decodePubSubData as n, extractMicrosoftGraphValidationToken as o, firstString as p, getHeader as q, resolveConnectLink as r, isMicrosoftGraphValidationHandshake as s, readBodyRecord as t, readQueryParam as u, toExternalId as v };
